...
const messages: Record<LocaleCode, Record<string, unknown>> = {
  pt: {
    ...
    analyzer: {
      ...
      import: 'Importar replay',
      importHint: 'Abra um .cs2dv exportado deste app',
  ...
  en: {
    ...
    analyzer: {
      ...
      importHint: 'Open a .cs2dv exported from this app',
  ...
  es: {
    ...
    analyzer: {
      ...
      import: 'Importar replay',
      importHint: 'Abre un .cs2dv exportado de esta app',
      importing: 'Importando replay...',
