 ...
 * `@/viewer/domain/schema` format, along with player voice (comms). No demo byte
 * leaves the machine.
 */
import init, { parse_demo } from '../parser/demo_parser.js'
import type { VoiceData } from '@/viewer/domain/schema'
import { parseVoiceBlob } from '@/viewer/player/voiceCodec'
